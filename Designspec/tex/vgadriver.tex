...
\begin{figure}[h]
  ...
  \label{tab:vgaio}
    \begin{tabular}{|l|c|l|}
      ...
      \hline
      \verb+{L,R}bar+ & Input & An 8-bit input containing signal sound input signal level\\
      \hline
      \verb+{L,R}new_bar+ & Input & An 8-bit input containing manipulated input signal level\\
      \hline

...
\usepackage{enumitem,mathtools,tikz,textcomp,fixltx2e,color,graphicx,afterpage,float,parskip,xfrac,gensymb,etoolbox}
...
\title{Group 41}
\subtitle{TSIU03 - Final Presentation}
